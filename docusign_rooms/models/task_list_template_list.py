...
class TaskListTemplateList(object):
    ...
    def __init__(self, task_list_templates=None, result_set_size=None, start_position=None, end_position=None, next_uri=None, prior_uri=None, total_row_count=None):  # noqa: E501
        ...
        if task_list_templates is not None:
            self.task_list_templates = task_list_templates
