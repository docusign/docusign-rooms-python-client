...
class ClassicManagerPermissions(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('is_visible_in_transaction_rooms'), kwargs.get('is_visible_in_transaction_rooms', None))
        setattr(self, "_{}".format('can_delete_company_rooms'), kwargs.get('can_delete_company_rooms', None))
        setattr(self, "_{}".format('can_delete_company_documents'), kwargs.get('can_delete_company_documents', None))
        setattr(self, "_{}".format('can_manage_company_rooms'), kwargs.get('can_manage_company_rooms', None))
        setattr(self, "_{}".format('can_manage_company_account'), kwargs.get('can_manage_company_account', None))
        setattr(self, "_{}".format('can_manage_company_shared_library'), kwargs.get('can_manage_company_shared_library', None))
        setattr(self, "_{}".format('can_manage_company_members'), kwargs.get('can_manage_company_members', None))
        setattr(self, "_{}".format('can_close_company_rooms'), kwargs.get('can_close_company_rooms', None))
        setattr(self, "_{}".format('can_approve_company_checklists'), kwargs.get('can_approve_company_checklists', None))
        setattr(self, "_{}".format('is_company_system_admin'), kwargs.get('is_company_system_admin', None))
        setattr(self, "_{}".format('is_region_manager'), kwargs.get('is_region_manager', None))
        setattr(self, "_{}".format('is_office_manager'), kwargs.get('is_office_manager', None))
        setattr(self, "_{}".format('auto_access_to_company_rooms'), kwargs.get('auto_access_to_company_rooms', None))
