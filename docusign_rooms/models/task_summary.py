...
class TaskSummary(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('task_id'), kwargs.get('task_id', None))
        setattr(self, "_{}".format('name'), kwargs.get('name', None))
        setattr(self, "_{}".format('requires_approval'), kwargs.get('requires_approval', None))
        setattr(self, "_{}".format('due_date_type_id'), kwargs.get('due_date_type_id', None))
        setattr(self, "_{}".format('due_date_offset'), kwargs.get('due_date_offset', None))
        setattr(self, "_{}".format('fixed_due_date'), kwargs.get('fixed_due_date', None))
        setattr(self, "_{}".format('owner_user_id'), kwargs.get('owner_user_id', None))
        setattr(self, "_{}".format('completion_date'), kwargs.get('completion_date', None))
        ...
        setattr(self, "_{}".format('is_document_task'), kwargs.get('is_document_task', None))
        setattr(self, "_{}".format('requires_review'), kwargs.get('requires_review', None))
