...
class Permissions(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('can_create_rooms'), kwargs.get('can_create_rooms', None))
        setattr(self, "_{}".format('can_submit_rooms_for_review'), kwargs.get('can_submit_rooms_for_review', None))
        setattr(self, "_{}".format('can_close_rooms'), kwargs.get('can_close_rooms', None))
        setattr(self, "_{}".format('can_reopen_rooms'), kwargs.get('can_reopen_rooms', None))
        setattr(self, "_{}".format('can_delete_owned_rooms'), kwargs.get('can_delete_owned_rooms', None))
        setattr(self, "_{}".format('auto_access_to_rooms'), kwargs.get('auto_access_to_rooms', None))
        setattr(self, "_{}".format('can_export_room_activity_details_people'), kwargs.get('can_export_room_activity_details_people', None))
        setattr(self, "_{}".format('can_copy_room_details'), kwargs.get('can_copy_room_details', None))
        setattr(self, "_{}".format('can_edit_any_room_role'), kwargs.get('can_edit_any_room_role', None))
        setattr(self, "_{}".format('can_edit_invited_room_role'), kwargs.get('can_edit_invited_room_role', None))
        setattr(self, "_{}".format('can_edit_room_side'), kwargs.get('can_edit_room_side', None))
        setattr(self, "_{}".format('can_manage_any_user_room_access'), kwargs.get('can_manage_any_user_room_access', None))
        setattr(self, "_{}".format('can_manage_invited_user_room_access'), kwargs.get('can_manage_invited_user_room_access', None))
        setattr(self, "_{}".format('is_hidden_in_room'), kwargs.get('is_hidden_in_room', None))
        ...
        setattr(self, "_{}".format('can_add_documents'), kwargs.get('can_add_documents', None))
        setattr(self, "_{}".format('can_add_documents_from_form_groups'), kwargs.get('can_add_documents_from_form_groups', None))
        setattr(self, "_{}".format('can_add_documents_from_form_libraries'), kwargs.get('can_add_documents_from_form_libraries', None))
        ...
        setattr(self, "_{}".format('can_delete_deletable_tasks'), kwargs.get('can_delete_deletable_tasks', None))
        setattr(self, "_{}".format('can_delete_any_tasks'), kwargs.get('can_delete_any_tasks', None))
        setattr(self, "_{}".format('can_apply_task_list'), kwargs.get('can_apply_task_list', None))
        setattr(self, "_{}".format('can_remove_any_task_list'), kwargs.get('can_remove_any_task_list', None))
        setattr(self, "_{}".format('can_submit_task_list'), kwargs.get('can_submit_task_list', None))
        setattr(self, "_{}".format('can_auto_submit_task_list'), kwargs.get('can_auto_submit_task_list', None))
        setattr(self, "_{}".format('can_review_task_list'), kwargs.get('can_review_task_list', None))
        setattr(self, "_{}".format('can_auto_approve_task_list'), kwargs.get('can_auto_approve_task_list', None))
        setattr(self, "_{}".format('can_manage_task_templates_for_all_regions_all_offices'), kwargs.get('can_manage_task_templates_for_all_regions_all_offices', None))
        setattr(self, "_{}".format('can_apply_room_templates'), kwargs.get('can_apply_room_templates', None))
        setattr(self, "_{}".format('can_add_tasks_to_rooms'), kwargs.get('can_add_tasks_to_rooms', None))
        setattr(self, "_{}".format('can_review_any_task'), kwargs.get('can_review_any_task', None))
        setattr(self, "_{}".format('can_manage_docs_on_any_task'), kwargs.get('can_manage_docs_on_any_task', None))
        setattr(self, "_{}".format('can_add_member_and_set_role_lower_access_level'), kwargs.get('can_add_member_and_set_role_lower_access_level', None))
        setattr(self, "_{}".format('can_add_member_and_set_role_same_access_level'), kwargs.get('can_add_member_and_set_role_same_access_level', None))
        setattr(self, "_{}".format('can_change_member_role_lower_access_level'), kwargs.get('can_change_member_role_lower_access_level', None))
        setattr(self, "_{}".format('can_change_member_role_same_access_level'), kwargs.get('can_change_member_role_same_access_level', None))
        setattr(self, "_{}".format('can_manage_member_lower_access_level'), kwargs.get('can_manage_member_lower_access_level', None))
        setattr(self, "_{}".format('can_manage_member_same_access_level'), kwargs.get('can_manage_member_same_access_level', None))
        setattr(self, "_{}".format('can_remove_company_member_lower_access_level'), kwargs.get('can_remove_company_member_lower_access_level', None))
        setattr(self, "_{}".format('can_remove_company_member_same_access_level'), kwargs.get('can_remove_company_member_same_access_level', None))
        setattr(self, "_{}".format('can_manage_account'), kwargs.get('can_manage_account', None))
        setattr(self, "_{}".format('can_manage_logo'), kwargs.get('can_manage_logo', None))
        setattr(self, "_{}".format('can_manage_roles_and_permissions'), kwargs.get('can_manage_roles_and_permissions', None))
    ...
    @property
    def can_create_form_templates(self):
        """Gets the can_create_form_templates of this Permissions.  # noqa: E501


        :return: The can_create_form_templates of this Permissions.  # noqa: E501
        :rtype: bool
        """
        return self._can_create_form_templates

    @can_create_form_templates.setter
    def can_create_form_templates(self, can_create_form_templates):
        """Sets the can_create_form_templates of this Permissions.


        :param can_create_form_templates: The can_create_form_templates of this Permissions.  # noqa: E501
        :type: bool
        """
