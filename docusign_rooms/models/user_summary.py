...
class UserSummary(object):
    ...
    def __init__(self, user_id=None, email=None, first_name=None, last_name=None, is_locked_out=None, status=None, access_level=None, default_office_id=None, title_id=None, role_id=None, profile_image_url=None):  # noqa: E501
