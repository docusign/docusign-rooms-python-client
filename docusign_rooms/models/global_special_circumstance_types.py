...
class GlobalSpecialCircumstanceTypes(object):
    ...
    def __init__(self, special_circumstance_types=None):  # noqa: E501
        """GlobalSpecialCircumstanceTypes - a model defined in Swagger"""  # noqa: E501

        self._special_circumstance_types = None
        self.discriminator = None

        if special_circumstance_types is not None:
            self.special_circumstance_types = special_circumstance_types
