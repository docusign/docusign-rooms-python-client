...
class PropertyType(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('property_type_id'), kwargs.get('property_type_id', None))
        setattr(self, "_{}".format('name'), kwargs.get('name', None))

    @property
    def property_type_id(self):
        """Gets the property_type_id of this PropertyType.  # noqa: E501


        :return: The property_type_id of this PropertyType.  # noqa: E501
        :rtype: str
        """
    ...
    def property_type_id(self, property_type_id):
        """Sets the property_type_id of this PropertyType.


        :param property_type_id: The property_type_id of this PropertyType.  # noqa: E501
        :type: str
        """
